...
| GitHub Repo      | LangChain DeepAgents(Multi-Agents)    | [`langchain_deepagents/deep_research`](./langchain_deepagents/deep_research/README.md)                 | https://langchain-ai.aiagenta2z.com/deep_research/chat                                                           | LangChain [Examples](https://github.com/langchain-ai/deepagents) DeepResearch Agent of Tavily and Gemini model                        |
